Описание
	TrayMessageQueue - Класс позволяет упростить вывод сообщений в Tray и представляет собой очередь сообщений которые последовательно показываются пользователю. Сообщения не будут перекрывать предведущее даже не дав ему показаться. Можно указать сколько какое сообщение будет показываться пользователю.
